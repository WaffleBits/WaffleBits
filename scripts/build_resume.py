...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with phase-separated warmup, opt-in Prometheus scrapes immediately around measured load, fail-closed server failure/queue gates, and measured OpenAI-compatible streaming TTFT/inter-chunk latency.",
    ]),
