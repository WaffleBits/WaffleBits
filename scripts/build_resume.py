...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with phase-separated warmup, opt-in DCGM sampling support across measured load, fail-closed server failure/queue gates, and measured OpenAI-compatible streaming TTFT/inter-chunk latency.",
    ]),
