...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with phase-separated warmup, paired Triton counter-window failure/queue gates, and measured OpenAI-compatible streaming TTFT and inter-chunk latency.",
    ]),
