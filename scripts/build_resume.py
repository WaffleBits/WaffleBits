...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with open-loop pacing, streaming and queue timing, measured client-attempt amplification budgets, sampled DCGM telemetry, privacy-safe trace checks, and numeric batch-output gates.",
    ]),
