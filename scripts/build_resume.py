...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with phase-separated warmup, opt-in W3C trace context, sampled DCGM gauges, privacy-preserving series-membership checks, fail-closed server gates, and measured streaming TTFT/inter-chunk latency.",
    ]),
