...
story = [
    ...
    *bullets([
        ...
        "Extended a serving benchmark with phase-separated warmup, sampled (not time-weighted) DCGM gauges, privacy-preserving series-membership checks, fail-closed server gates, and measured OpenAI-compatible streaming TTFT/inter-chunk latency.",
    ]),
