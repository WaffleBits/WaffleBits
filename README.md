...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with open-loop pacing, measured client-attempt amplification and an enforceable retry budget, streaming and queue timing, sampled GPU gauges, privacy-safe trace continuation, and numeric batch-output gates. A client attempt is a harness call, not proof of server receipt.
