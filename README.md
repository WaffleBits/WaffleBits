...
- AI reliability / production engineering teams: SLOs, Prometheus-compatible artifacts, incident runbooks, release gates, triage routing, failure accounting, deterministic fixtures, trace/replay tooling, token-path telemetry, streaming trace coverage, OpenTelemetry/Grafana direction, resilience testing direction, and telemetry that makes regressions visible.
