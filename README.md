...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with phase-separated warmup, streaming TTFT/inter-chunk measurements, and fail-closed failure-rate and queue-fraction gates from paired server counters.
