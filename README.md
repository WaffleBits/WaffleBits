...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with phase-separated warmup, explicit workload profiles, streaming TTFT/inter-chunk measurements, telemetry correlation, and regression gates.
