...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with open-loop pacing, measured retry amplification, and opt-in ingress/backend/success counter reconciliation around the measured phase. The exact path gate requires counters isolated to the run; aggregate agreement does not prove per-request causality.
