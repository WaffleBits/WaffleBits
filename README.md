...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with open-loop request pacing, measured streaming and queue latency, sampled DCGM gauges, privacy-safe trace continuation, and exact-by-default numeric batch-output gates with explicit run-scoped tolerances.
