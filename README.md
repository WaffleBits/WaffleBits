...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with phase-separated warmup, sampled (not time-weighted) DCGM gauges, streaming TTFT/inter-chunk measurements, fail-closed server-counter gates, and an opt-in response trace-continuation gate that retains classifications rather than identifiers.
