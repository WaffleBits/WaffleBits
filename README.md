...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with phase-separated warmup, opt-in W3C trace context, sampled (not time-weighted) DCGM gauges, hashed series-membership validation, streaming TTFT/inter-chunk measurements, and fail-closed server-counter gates.
