...
- [triton-inference-benchmark](https://github.com/WaffleBits/triton-inference-benchmark): load-generation toolkit for Triton and OpenAI-compatible serving, with phase-separated warmup, opt-in sampled (not time-weighted) DCGM gauge windows, hashed series-membership validation, streaming TTFT/inter-chunk measurements, and fail-closed server-counter gates.
