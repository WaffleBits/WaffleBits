...
export const caseFiles: CaseFile[] = [
  {
    ...
    evidence: "Sanitized trace logs, OTLP trace export, deployment-readiness gates (shadow / canary / staged / rollback), resilience-drill evidence, a bounded aggregate endpoint probe, aggregate telemetry correlation, CI-enforced pinned dependency audit, SPDX image SBOM, high-severity container scanning, executable deployment-posture tests, Grafana dashboards, and incident runbooks.",
