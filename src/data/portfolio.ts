...
export const caseFiles: CaseFile[] = [
  ...
  },
  {
    ...
    system: "Repeatable load-generation harness for NVIDIA Triton-style and OpenAI-compatible serving with open-loop pacing, concurrency controls, and measured retry/failure accounting.",
    evidence: "Warmup and measurement run as separate phases. JSON and Prometheus artifacts distinguish logical requests from client attempts, and an opt-in gate fails excessive retry amplification. Server counters are scraped around measured load; trace, output-correctness, and telemetry gates retain aggregate-only evidence boundaries.",
...
export const proof: Proof[] = [
  ...
  { label: "server evidence gate", kind: "verified",
    plain: "The harness scrapes server counters immediately around measured load; failure-rate or queue-share regressions and missing evidence block the run.",
