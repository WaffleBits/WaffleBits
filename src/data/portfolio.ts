...
export const caseFiles: CaseFile[] = [
  ...
  },
  {
    ...
    evidence: "Separate warmup and measured phases in JSON and Prometheus output, plus three explicit workload shapes, OpenAI-compatible streaming TTFT/inter-chunk measurements, Triton/DCGM telemetry correlation, batch-invariance checks, cost estimates, and regression gates.",
...
export const proof: Proof[] = [
  ...
  { label: "benchmark phases", kind: "verified",
    plain: "Warmup stays separate from measured results across three repeatable traffic shapes.",
