...
export const caseFiles: CaseFile[] = [
  ...
  },
  {
    ...
    system: "Repeatable load-generation harness for NVIDIA Triton-style and OpenAI-compatible serving with open-loop pacing, concurrency controls, measured retry accounting, and operator-selected serving-path counters.",
    evidence: "Warmup and measurement run as separate phases. JSON and Prometheus artifacts reconcile client attempts with ingress, backend, and success counter deltas without retaining raw metric names or labels. Exact accounting is opt-in and requires counters isolated to the run; aggregate agreement is not per-request causality.",
...
export const proof: Proof[] = [
  ...
  { label: "server evidence gate", kind: "verified",
    plain: "The harness reconciles client attempts with privacy-safe ingress, backend, and success counter deltas around measured load.",
