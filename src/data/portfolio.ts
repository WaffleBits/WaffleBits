...
export const caseFiles: CaseFile[] = [
  {
    ...
    evidence: "Sanitized trace logs, OTLP trace export, deployment-readiness gates (shadow / canary / staged / rollback), resilience-drill evidence, a bounded aggregate endpoint probe, aggregate telemetry correlation, optional Redis Lua limiter controls with hashed keys, CI-enforced pinned dependency audit, SPDX image SBOM, high-severity container scanning, executable deployment-posture tests, Grafana dashboards, and incident runbooks.",
  ...
  },
  {
    ...
    evidence: "Latency percentiles, throughput, Prometheus export, regression gates, batch-invariance checks, cost-per-request estimates, and explicit interactive / long-context / throughput profiles that record token, batch, TTFT, decode, and KV-cache assumptions.",
...
export const proof: Proof[] = [
  ...
  { label: "workload profiles", kind: "measured",
    plain: "Repeatable interactive, long-context, and throughput shapes for comparing serving behavior under explicit assumptions.",
  ...
  { label: "telemetry correlation", kind: "operational",
    plain: "A safe metrics snapshot joining request outcomes, token totals, latency bounds, and probe status.",
