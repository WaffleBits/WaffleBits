...
export const caseFiles: CaseFile[] = [
  ...
  },
  {
    ...
    evidence: "Separate warmup and measured phases, three workload shapes, measured OpenAI-compatible TTFT/inter-chunk timing, and paired Triton counter windows with fail-closed failure-rate and queue-fraction gates. Artifacts omit raw scrapes and operator paths and label snapshot alignment as unverified.",
...
export const proof: Proof[] = [
  ...
  { label: "server evidence gate", kind: "verified",
    plain: "Before/after server counters become failure-rate and queue-share checks; missing evidence blocks the run.",
